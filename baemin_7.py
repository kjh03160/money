...
def baemin_7(driver, date):
    ...
    while not nav.get_attribute("disabled"):
        ...
        for order in order_list:
            ...
            order_time = datetime.datetime(test[0],test[1], test[2])
            ...
            temp['접수시각'] = driver.find_by_tag_with_obj(trs2[7], "td").text
            temp['배달시각'] = driver.find_by_tag_with_obj(trs2[8], "td").text
